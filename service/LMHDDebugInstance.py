...
def main():
	try:
		...
		while (Continue == True):
			...
			# if (hand.position_a()):
				# print("Position : A : True")
			# else :
				# print ("Position : A : False")
			# if (hand.position_b()):
				# print("Position : B : True")
			# else :
				# print ("Position : B : False")
			# if (hand.position_c()):
				# print("Position : C : True")
			# else :
				# print ("Position : C : False")
			# if (hand.position_d()):
				# print("Position : D : True")
			# else :
				# print ("Position : D : False")
			# if (hand.position_e()):
				# print("Position : E : True")
			# else :
				# print ("Position : E : False")
			# if (hand.position_regular()):
				# print("Position : REG : True")
			# else :
				# print ("Position : REG : False")
			# if (hand.position_fist()):
			...
			# else :
				# print ("Position : FV : False")
			# if (hand.position_revert_spiderman()):
				# print("Position : RS : True")
			# else :
				# print ("Position : RS : False")
			print (">>>>>>>>>>>")
